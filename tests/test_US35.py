...
class TestRecentBirth(unittest.TestCase):
    ...
    def test_recent_birth(self):
        indilist = [
            ...
            {'INDI': '@I4@', 'NAME': 'Zhishan /Xue/', 'SEX': 'M', 'BIRT': '1934-04-12', 'DEAT': '1984-08-23',
        ...
        self.assertIs(recent_birth(indilist), None)
        self.assertIs(recent_birth(indilist), None)
        self.assertIs(recent_birth(indilist), None)
        self.assertEqual(recent_birth(indilist), None)
        self.assertIs(recent_birth(indilist), None)

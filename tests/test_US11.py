...
class TestNoBigamy(unittest.TestCase):
    ...
    def test_no_bigamy(self):
        self.assertFalse( no_bigamy([{'SPOUSE': ['@F1@', '@F2@'],'num':10}],
        ...
        self.assertTrue(no_bigamy([{'SPOUSE': ['@F1@', '@F2@'],'num':10}], [{'FAM':'@F1@','MARR': '1993-08-15','DIV':'1995-08-15'},{'FAM':'@F2@','MARR': '1996-08-16','DIV':'1997-08-15','num':14}]))
        self.assertTrue(no_bigamy([{'SPOUSE': ['@F1@', '@F2@'],'num':10}], [{'FAM':'@F1@','MARR': '1993-08-15','DIV':'1995-08-15'},{'FAM':'@F2@','MARR': '1996-08-15','DIV':'1997-08-15','num':14}]))

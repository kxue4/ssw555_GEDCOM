...
class TestSibsShouldNotMarry(unittest.TestCase):

    def test_sibs_should_not_marry(self):
        ...
        self.assertEqual(sibs_should_not_marry(f[0:1]), True)
        self.assertEqual(sibs_should_not_marry(f[1:2]), True)
        self.assertEqual(sibs_should_not_marry(f[2:3]), True)
        self.assertEqual(sibs_should_not_marry(f[3:]), True)
        self.assertEqual(sibs_should_not_marry(f), False)
